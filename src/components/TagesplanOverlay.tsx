                            ...
                            <div className="space-y-1.5">
                              {slots.map((slot, i) => (
                                <div key={i}>
                                   ...
                                   {slot.isWalk && (
                                    <div className={`w-full p-2 rounded-lg overflow-hidden info-overlay-card ${slot.isFutureEstimate ? 'opacity-60' : ''}`}>
                                   ...
                                   {slot.icalEvents.filter(evt => !evt.isMedicalIcal).map((evt, j) => (
                                      <div key={j} className={slot.isWalk ? 'mt-1.5' : ''}>
                                        <div className="w-full p-2 rounded-lg info-overlay-card">
                              ...
                              {dayMedicalEvents.map((mev, mi) => (
                                <div key={`med-${mi}`} className="w-full p-2 rounded-lg overflow-hidden info-overlay-card">
                                  <div className="flex items-center gap-1.5">
                              ...
                              {medicalIcalEvents.map((mev, mi) => (
                                <div key={`medIcal-${mi}`} className="w-full p-2 rounded-lg overflow-hidden info-overlay-card">
                                  <div className="flex items-center gap-1.5">
