        ...
        <div className="fixed left-0 right-0 pointer-events-auto pwa-info-overlay-root" style={{ top: 0, bottom: 0, background: 'hsl(var(--spot-color))' }}>
          ...
          <div className="fixed top-0 left-0 right-0 overflow-y-auto overflow-x-hidden px-4 pwa-info-overlay-scroll" style={{ bottom: 0, paddingTop: 'calc(56px + env(safe-area-inset-top, 0px))', paddingBottom: 32, background: 'hsl(var(--spot-color))' }}>
            ...
            <div className="mb-2">
              ...
              <div className="bg-white/20 backdrop-blur-[8px] rounded-[16px] border border-[#FFFEF5]/40 shadow-[0_0_16px_rgba(0,0,0,0.08)] p-4 mb-2">
                <a 
              ...
              <div className="bg-white/20 backdrop-blur-[8px] rounded-[16px] border border-[#FFFEF5]/40 shadow-[0_0_16px_rgba(0,0,0,0.08)] p-4">
                <a 
