          ...
          <div className="fixed top-0 left-0 right-0 overflow-y-auto overflow-x-hidden px-4 pwa-info-overlay-scroll" style={{ bottom: 0, paddingTop: 'calc(56px + env(safe-area-inset-top, 0px))', paddingBottom: 32, background: 'hsl(var(--spot-color))' }}>
            ...
            {!dataLoaded && (
              <div className="mb-8">
                ...
                <div className="bg-white/[0.06] backdrop-blur-[12px] rounded-[12px] border border-white/10 overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.12)]">
                  {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            <div className="mb-2">
              ...
              <div className="bg-white/[0.06] backdrop-blur-[12px] rounded-[12px] border border-white/10 p-4 mb-2 shadow-[0_2px_8px_rgba(0,0,0,0.12)]">
                <a 
            ...
            {(() => {
              ...
              return (
                <div className="mb-8">
                  ...
                  <div 
                    className="bg-white/[0.06] backdrop-blur-[12px] rounded-[12px] border border-white/10 overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.12)]"
                  >
            ...
            {(() => {
              ...
              return (
                <div className="mb-8">
                  ...
                  <div className="bg-white/[0.06] backdrop-blur-[12px] rounded-[12px] border border-white/10 overflow-hidden p-4 shadow-[0_2px_8px_rgba(0,0,0,0.12)]">
