...
const TagesplanOverlay = ({ isOpen, onClose, scrollToDate }: TagesplanOverlayProps) => {
  ...
  return (
    <div className="fixed inset-0 z-40 pointer-events-none" style={{ minHeight: '100dvh' }}>
      ...
      {animationPhase === 'visible' && (
        <div className="fixed inset-0 pointer-events-auto pwa-info-overlay-root" style={{ background: 'hsl(var(--spot-color))' }}>
          ...
          <div className="fixed inset-0 overflow-y-auto overflow-x-hidden px-4 pwa-info-overlay-scroll" style={{ paddingTop: 'calc(56px + env(safe-area-inset-top, 0px))', paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 16px)', background: 'hsl(var(--spot-color))' }}>
