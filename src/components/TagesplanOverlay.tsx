                                   ...
                                   {slot.isWalk && (
                                    <div className="p-2 bg-white/[0.06] rounded-lg">
                                      <div className="flex items-center">
                                        <span className="text-[12px] text-white/70 shrink-0 w-[80px]">{formatTime(slot.avgHour)} Uhr</span>
                                     ...
                                     <div key={j} className={slot.isWalk ? 'mt-1.5' : ''}>
                                       <div className="p-2 bg-white/[0.06] rounded-lg">
                                         <div className="flex items-start">
                                           <span className="text-[12px] text-white/70 shrink-0 w-[80px]">{evt.timeStr} Uhr</span>
