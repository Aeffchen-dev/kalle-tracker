...
const TagesplanOverlay = ({ isOpen, onClose, scrollToDate }: TagesplanOverlayProps) => {
  ...
  return (
    <div className="fixed inset-0 z-40 pointer-events-none" style={{ minHeight: '100dvh' }}>
      ...
      {animationPhase === 'visible' && (
        <div className="fixed left-0 right-0 pointer-events-auto pwa-info-overlay-root" style={{ top: 'calc(-1 * env(safe-area-inset-top, 0px))', bottom: 0, paddingTop: 'env(safe-area-inset-top, 0px)', background: 'hsl(var(--spot-color))' }}>
