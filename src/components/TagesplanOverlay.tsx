                            ...
                            <div className="space-y-1.5">
                              {slots.map((slot, i) => (
                                <div key={i}>
                                   ...
                                   {slot.isWalk && (
                                    <div className={`p-2 glass-card overflow-hidden ${slot.isFutureEstimate ? 'opacity-30' : ''}`}>
                              ...
                              {dayMedicalEvents.map((mev, mi) => (
                                <div key={`med-${mi}`} className="p-2 glass-card overflow-hidden">
                                  <div className="flex items-center gap-1.5">
                              ...
                              {medicalIcalEvents.map((mev, mi) => (
                                <div key={`medIcal-${mi}`} className="p-2 glass-card overflow-hidden">
                                  <div className="flex items-center gap-1.5">
