                            ...
                            <div className="space-y-1.5">
                              {slots.map((slot, i) => (
                                <div key={i}>
                                   ...
                                   {slot.isWalk && (
                                    <div className={`p-2 rounded-lg overflow-hidden bg-white/[0.08] backdrop-blur-sm border border-white/[0.1] ${slot.isFutureEstimate ? 'opacity-30' : ''}`}>
                                   ...
                                   {slot.icalEvents.filter(evt => !evt.isMedicalIcal).map((evt, j) => (
                                      <div key={j} className={slot.isWalk ? 'mt-1.5' : ''}>
                                        <div className="p-2 rounded-lg bg-white/[0.08] backdrop-blur-sm border border-white/[0.1]">
                              ...
                              {dayMedicalEvents.map((mev, mi) => (
                                <div key={`med-${mi}`} className="p-2 rounded-lg overflow-hidden bg-white/[0.08] backdrop-blur-sm border border-white/[0.1]">
                                  <div className="flex items-center gap-1.5">
                              ...
                              {medicalIcalEvents.map((mev, mi) => (
                                <div key={`medIcal-${mi}`} className="p-2 rounded-lg overflow-hidden bg-white/[0.08] backdrop-blur-sm border border-white/[0.1]">
                                  <div className="flex items-center gap-1.5">
