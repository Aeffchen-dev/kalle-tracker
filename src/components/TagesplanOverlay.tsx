    ...
    <div className="fixed inset-0 z-40 pointer-events-none" style={{ minHeight: '100dvh' }}>
      ...
      {animationPhase === 'visible' && (
        <div className="fixed left-0 right-0 pointer-events-auto pwa-info-overlay-root" style={{ top: 0, bottom: 0, background: 'hsl(var(--spot-color))' }}>
          ...
          <div className="fixed top-0 left-0 right-0 overflow-visible px-4 pwa-info-overlay-scroll" style={{ bottom: 0, paddingTop: 'calc(56px + env(safe-area-inset-top, 0px))', paddingBottom: 0, overflow: 'visible', background: 'hsl(var(--spot-color))' }}>
