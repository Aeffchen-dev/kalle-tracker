                  ...
                  {filteredEvents.map((event) => {
                    ...
                    return (
                      <div key={event.id} className="relative flex w-full items-stretch overflow-hidden">
                        <div
                          className={`flex items-center justify-between p-3 bg-white/20 rounded-lg cursor-pointer select-none transition-[margin] duration-150 ease-linear min-w-0 flex-1 ${isActive ? 'mr-[90px]' : 'mr-0'}`}
