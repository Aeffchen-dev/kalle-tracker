                        ...
                        return (
                          <div key={`pred-${gi}`} className="flex items-center justify-between px-3 py-3.5 rounded-lg opacity-60">
                            <span className="text-[14px] text-white flex items-center gap-1.5">
                              {entry.hasPipi && entry.hasPoop ? <span className="shrink-0 relative w-[1.2em] h-[1.2em]"><span className="absolute inset-0">💦</span><span className="absolute inset-0 z-10">💩</span></span> : <span className="shrink-0">{entry.hasPoop ? '💩' : '💦'}</span>}
                              ...
                              <div className="flex items-start justify-between w-full overflow-hidden">
                                <div className="flex items-center gap-1.5">
                                  {group.events.length === 2 && group.events.some(e => e.type === 'pipi') && group.events.some(e => e.type === 'stuhlgang') ? (
                                    <>
                                      <span className="text-[14px] shrink-0 relative w-[1.2em] h-[1.2em]"><span className="absolute inset-0">💦</span><span className="absolute inset-0 z-10">💩</span></span>
