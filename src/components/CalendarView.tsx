    ...
    <>
      ...
      <DrawerContent className="bg-black border-black flex flex-col h-full">
        ...
        <div 
          ...
          data-vaul-no-drag={snap === 0.9 && isContentScrollable ? true : undefined}
              ...
              {filteredEvents.length === 0 && !isBirthdayToday ? (
                ...
                <div className="space-y-2 pb-20">
                  ...
                  {isBirthdayToday && birthdayAge > 0 && (
                    <div className="flex items-center justify-between p-3 bg-white/[0.06] backdrop-blur-sm rounded-lg">
