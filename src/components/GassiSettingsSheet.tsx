      ...
      <DrawerContent className="bg-black border-black flex flex-col max-h-[95dvh]">
        ...
        {isLoading ? (
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-16 w-full bg-white/8 rounded-xl animate-pulse" />
            ))}
          </div>
        ) : (
          <div className="space-y-3 pb-4">
            {/* Walk Interval Setting */}
            <div className="bg-white/8 rounded-lg p-4">
            ...
            <label className="bg-white/8 rounded-lg p-4 flex items-center justify-between cursor-pointer relative block">
