...
const GassiSettingsSheet = ({ open, onOpenChange, onSettingsChanged }: GassiSettingsSheetProps) => {
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange} snapPoints={[0.95]}>
      <DrawerContent className="bg-black border-black flex flex-col max-h-[95dvh]">
        ...
        <div className="px-4 pb-4 overflow-y-auto flex-1" style={{ minHeight: 0 }}>
        {isLoading ? (
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="h-16 w-full bg-white/[0.06] backdrop-blur-sm rounded-xl animate-pulse" />
            ))}
          </div>
        ) : (
          <div className="space-y-3 pb-4">
            {/* Walk Interval Setting */}
            <div className="bg-white/[0.06] backdrop-blur-sm rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[14px] text-white/70 w-[2ch] text-center">{intervalHours}h</span>
                  <button
            ...
            <label className="bg-white/[0.06] backdrop-blur-sm rounded-lg p-4 flex items-center justify-between cursor-pointer relative block">
              ...
              <div className="flex items-center">
                ...
                <span className="text-[14px] text-white/70 ml-1">Uhr</span>
              </div>
              <input
                type="time"
                value={morningTime}
            ...
            <div className="bg-white/[0.06] backdrop-blur-sm rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[14px] text-white/70">Uhr</span>
                </div>
              </div>
            </div>
