...
const drawerContentVariants = cva(
  ...
  "fixed inset-x-0 bottom-0 z-50 flex h-auto flex-col rounded-t-[20px] border-0 bg-black outline-none focus:outline-none focus-visible:outline-none lg:max-w-[80vw] lg:mx-auto pb-[env(safe-area-inset-bottom,0px)] after:content-[''] after:absolute after:left-0 after:right-0 after:top-full after:h-[100px] after:bg-black",
  {
    variants: {
      variant: {
...
const DrawerHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("grid gap-1.5 px-4 pt-8 pb-4 text-center sm:text-left", className)} {...props} />
);
