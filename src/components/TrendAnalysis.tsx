    ...
    <div className="space-y-2" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 80px)' }} data-vaul-no-drag>
      ...
      <div className="mt-8 flex justify-center">
        <Button
          ...
          className="h-10 px-6 min-w-[300px] text-[14px] bg-[#5AD940] text-black hover:bg-[#4fc936] disabled:bg-[#5AD940] disabled:text-black/50 disabled:opacity-100 rounded-[999px] gap-3"
        >
