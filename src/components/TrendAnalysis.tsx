...
const StatCard = memo(({ 
  ...
  <div className="bg-white/[0.06] backdrop-blur-[12px] rounded-lg border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.12)] p-3">
...
const TrendAnalysis = memo(({ events, scrollToChart }: TrendAnalysisProps) => {
  ...
  return (
    <div className="pb-11 space-y-2" data-vaul-no-drag>
      {/* Age Display */}
      <div className="w-full bg-white/[0.06] backdrop-blur-[12px] rounded-lg border border-white/10 shadow-[0_2px_8px_rgba(0,0,0,0.12)] p-4 flex items-center justify-center">
      ...
      <div className="mt-8" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 16px)' }}>
        <Button
          ...
          className="w-full h-10 text-[14px] bg-[#5AD940] text-black hover:bg-[#4fc936] disabled:bg-[#5AD940] disabled:text-black/50 disabled:opacity-100 rounded-[999px]"
        >
