    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="bg-black border-black overflow-hidden">
        ...
        <div className="px-4 pb-4 space-y-4 overflow-hidden">
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 h-10 rounded-lg text-[14px] font-medium transition-all duration-200 ${
                        selectedPh === ph
                          ? 'bg-white text-black'
                          : `bg-white/8 ${isRed ? 'text-red-500' : 'text-white'} hover:bg-white/12`
                      }`}
                    >
                      {ph}
                    </button>
          ...
          {selectedTypes.has('gewicht') && (
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-center h-12 bg-white/8 rounded-lg" style={{ width: 'calc(100vw - 32px)' }}>
                <input
                  type="text"
                  inputMode="decimal"
                  value={weightValue}
          ...
          <div>
            <label className="flex items-center h-12 bg-white/8 rounded-lg cursor-pointer relative" style={{ width: 'calc(100vw - 32px)' }}>
