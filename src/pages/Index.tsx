...
const Index = () => {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-transparent relative pb-[env(safe-area-inset-bottom)]">
      ...
      {/* Header */}
      <header className={`pt-[12px] px-4 pb-4 flex justify-between items-start relative z-10 transition-opacity duration-500 md:px-[3vw] md:pt-[2vw] md:pb-[2vw] lg:px-[2vw] lg:pt-[1.4vw] lg:pb-[1.4vw] ${showCard ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex items-start gap-2 md:gap-[1vw] lg:gap-[0.7vw]">
          <button 
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="text-[14px] md:text-[3vw] lg:text-[2vw] bg-white/20 backdrop-blur-[8px] text-black border border-[#FFFEF5]/40 rounded-full py-[2px] px-[8px] md:py-[0.8vw] md:px-[2vw] lg:py-[0.5vw] lg:px-[1.4vw] cursor-pointer mt-2 md:mt-[1vw] lg:mt-[0.7vw]"
          >
            <span className="flex items-center gap-2 md:gap-[1vw] lg:gap-[0.7vw]">🐶 <span>Kalle</span></span>
          </button>
          {weatherTemp !== null && (
            <button 
              ...
              className="text-[14px] md:text-[3vw] lg:text-[2vw] bg-white/20 backdrop-blur-[8px] text-black border border-[#FFFEF5]/40 rounded-full py-[2px] px-[8px] md:py-[0.8vw] md:px-[2vw] lg:py-[0.5vw] lg:px-[1.4vw] cursor-pointer mt-2 md:mt-[1vw] lg:mt-[0.7vw]"
            >
              <span className="flex items-center gap-2 md:gap-[1vw] lg:gap-[0.7vw]">{weatherEmoji} <span>{weatherTemp}°</span></span>
            </button>
          )}
        </div>
        <button 
      ...
      {/* Main countdown area */}
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 pb-[calc(20vh+40px)] px-4 gap-3 mx-auto w-full md:max-w-[60vw]">
        <div 
      ...
      <Drawer open={showWeather} onOpenChange={setShowWeather}>
        <DrawerContent className="bg-black rounded-t-[24px] border-0 max-h-[95dvh] z-[60] lg:max-w-[60vw] lg:mx-auto">
