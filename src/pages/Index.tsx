    ...
    <div className="min-h-dvh flex flex-col bg-transparent relative pb-[env(safe-area-inset-bottom)]">
      ...
      <header className={`pt-[12px] px-4 pb-4 flex justify-between items-start relative z-10 transition-opacity duration-500 md:px-[2.5vw] md:pt-[1.7vw] md:pb-[1.7vw] lg:px-[2vw] lg:pt-[1.4vw] lg:pb-[1.4vw] ${showCard ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex items-start gap-2 md:gap-[0.85vw] lg:gap-[0.7vw]">
          ...
          >
            <span className="flex items-center gap-1.5 md:gap-[0.85vw] lg:gap-[0.7vw]"><span className="text-[20px]">🐶</span> <span>Kalle</span></span>
          </button>
          {weatherTemp !== null && (
            <button 
              ...
              className="text-[14px] md:text-[2.55vw] lg:text-[2vw] bg-white/20 backdrop-blur-[8px] text-black border border-[#FFFEF5]/40 rounded-full py-[3px] px-[10px] md:py-[0.68vw] md:px-[1.7vw] lg:py-[0.5vw] lg:px-[1.4vw] cursor-pointer mt-2 md:mt-[0.85vw] lg:mt-[0.7vw]"
            >
              <span className="flex items-center gap-1.5 md:gap-[0.85vw] lg:gap-[0.7vw]"><span className="text-[20px]">{weatherEmoji}</span> <span>{weatherTemp}°</span></span>
            </button>
          )}
        </div>
        <button 
          onClick={() => setShowTagesplan(true)}
          className="text-[14px] md:text-[2.55vw] lg:text-[2vw] bg-white/20 backdrop-blur-[8px] text-black border border-[#FFFEF5]/40 rounded-full py-[3px] px-[10px] md:py-[0.68vw] md:px-[1.7vw] lg:py-[0.5vw] lg:px-[1.4vw] cursor-pointer mt-2 md:mt-[0.85vw] lg:mt-[0.7vw] leading-[20px]"
        >
          Info
        </button>
      </header>
