    ...
    <div className="h-dvh flex flex-col bg-transparent relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 pb-[20vh]">
        ...
        <button
          ...
          className="mt-4 text-[14px] h-12 px-8 rounded-[999px] bg-white/20 backdrop-blur-[16px] outline-none border border-gray-400/20 flex items-center justify-center"
        >
          Eintrag hinzufügen
        </button>
      </main>
