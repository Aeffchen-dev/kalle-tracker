                ...
                {hasInfoBox && (
                  <div className="flex flex-col gap-0.5 mt-1">
                    {weatherTemp !== null && weatherTemp <= 7 && (
                      <div className="rounded-lg rounded-t-none py-1.5 backdrop-blur-xl border border-white/15 bg-gradient-to-br from-white/15 to-white/5 flex items-center gap-3 px-3">
                    ...
                    {currentWeatherCode !== null && isRainCode(currentWeatherCode) && (
                      <div className="rounded-lg rounded-t-none p-3 backdrop-blur-xl border border-white/15 bg-gradient-to-br from-white/15 to-white/5 flex items-center gap-3">
