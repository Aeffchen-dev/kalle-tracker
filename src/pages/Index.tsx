      ...
      <header className={`pt-[12px] px-4 pb-4 flex justify-between items-start relative z-10 transition-opacity duration-500 ${showCard ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex items-start gap-2">
          <button 
            ...
            className="w-[48px] h-[48px] flex items-center justify-center text-[28px] bg-white/20 backdrop-blur-[8px] text-black border border-[#FFFEF5]/40 rounded-full cursor-pointer"
          >
            🐶
          </button>
          {weatherTemp !== null && (
