...
const Index = () => {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-transparent relative pb-[env(safe-area-inset-bottom)]">
      ...
      {/* Main countdown area */}
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 pb-[calc(20vh+40px)] px-4 gap-3 mx-auto w-full md:max-w-[40vw]">
        <div 
      ...
      <Drawer open={showWeather} onOpenChange={setShowWeather}>
        <DrawerContent className="bg-black rounded-t-[24px] border-0 max-h-[95dvh] z-[60] lg:max-w-[40vw] lg:mx-auto">
