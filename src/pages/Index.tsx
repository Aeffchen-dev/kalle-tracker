      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-4 gap-3 mx-auto w-full md:max-w-[60vw] lg:max-w-[50vw] main-with-sheet-offset">
        ...
        >
          ...
          <button 
            ...
            className="text-[40px] md:text-[56px] leading-none cursor-pointer tabular-nums"
          >
            {timeDisplay}
          </button>
          <button
            onClick={() => setEventSheetOpen(true)}
            className="mt-4 text-[14px] h-10 px-6 min-w-[200px] rounded-[999px] bg-[#5AD940] text-black flex items-center justify-center"
          >
            Eintrag hinzufügen
          </button>
        </div>
