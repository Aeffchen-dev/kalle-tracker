                  ...
                  <div className="flex items-center">
                    ...
                    <span className="flex-1 flex justify-center shrink-0">
                      {isRainCode(isToday && currentWeatherCode !== null ? currentWeatherCode : day.weatherCode) ? (
                        <span className="text-white/50 text-[14px] leading-[20px] inline-flex items-center gap-[4px]"><img src={rainIcon} alt="rain" className="w-[14px] h-[14px] opacity-50" />{String(day.precipSum).replace('.', ',')} mm</span>
                      ) : day.precipProbability > 30 ? (
                        <span className="text-white/50 text-[14px] leading-[20px] inline-flex items-center gap-[4px]"><img src={rainIcon} alt="rain" className="w-[14px] h-[14px] opacity-50" />{day.precipProbability}%</span>
